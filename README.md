...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-29 13:33`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/788e6c28-9d7d-419f-9eb3-6bfdbd5b30f4.git
$ cd 788e6c28-9d7d-419f-9eb3-6bfdbd5b30f4
```
